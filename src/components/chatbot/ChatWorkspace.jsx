...
export default function ChatWorkspace() {
  ...
  return (
    <div className="flex-1 flex flex-col h-[calc(100vh-88px)] relative overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-10 md:px-16 custom-scrollbar">
        <div className="max-w-[900px] mx-auto flex flex-col gap-14 pb-36">
          
          {/* Welcome / Header Area */}
          <div className="flex flex-col gap-2 mb-4 border-b border-slate-100/60 pb-6">
            <span className="text-[13px] text-brand-dark font-semibold tracking-wider">CIVIC SYSTEM CAPABILITY</span>
            <h2 className="text-[32px] md:text-[40px] font-extrabold tracking-tight text-primaryText leading-none">AI Chatbot</h2>
            <p className="text-[15px] text-slate-650 leading-relaxed font-normal">Converse with the neural inspection node to analyze infrastructure anomalies and coordinate dispatches.</p>
          </div>
