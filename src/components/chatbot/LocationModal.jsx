                ...
                <div className="flex-1 min-h-[240px]">
                  {activeTab === 'map' ? (
                    ...
                    <div className="flex flex-col gap-4.5">
                      ...
                      <div className="p-4.5 rounded-2xl bg-slate-50 border border-slate-100/60 flex items-center justify-between text-xs gap-4 shadow-sm">
                        <div className="flex flex-col gap-0.5 flex-1 min-w-0">
                          <span className="text-[13px] font-semibold text-slate-500 uppercase tracking-wider">RESOLVED MAP LOCATION</span>
                        ...
                        <button
                          ...
                          disabled={loading}
                          className="flex items-center gap-1.5 px-6 py-4.5 rounded-2xl bg-slate-950 hover:bg-slate-800 text-white font-bold text-[14px] tracking-normal transition-colors shadow-sm outline-none shrink-0"
                        >
                          <span>Confirm</span>
                    ...
                    <form onSubmit={handleManualSubmit} className="flex flex-col gap-5">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div className="relative">
                          <input
                            ...
                            required
                            className="w-full px-5 py-4 rounded-2xl bg-white border border-slate-200 focus:border-brand-dark focus:ring-1 focus:ring-brand-dark/20 text-[15px] font-semibold text-slate-900 transition-all duration-300 outline-none placeholder:text-mutedText"
                          />
                          <label className="absolute -top-2 left-4 bg-white px-2 text-[13px] font-semibold text-slate-650 tracking-wider">ROAD NAME *</label>
                        </div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full px-5 py-4 rounded-2xl bg-white border border-slate-200 focus:border-brand-dark focus:ring-1 focus:ring-brand-dark/20 text-[15px] font-semibold text-slate-900 transition-all duration-300 outline-none placeholder:text-mutedText"
                          />
                          <label className="absolute -top-2 left-4 bg-white px-2 text-[13px] font-semibold text-slate-650 tracking-wider">AREA / LOCALITY</label>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div className="relative">
                          <input
                            ...
                            required
                            className="w-full px-5 py-4 rounded-2xl bg-white border border-slate-200 focus:border-brand-dark focus:ring-1 focus:ring-brand-dark/20 text-[15px] font-semibold text-slate-900 transition-all duration-300 outline-none"
                          />
                          <label className="absolute -top-2 left-4 bg-white px-2 text-[13px] font-semibold text-slate-650 tracking-wider">CITY / CORPORATION *</label>
                        </div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full px-5 py-4 rounded-2xl bg-white border border-slate-200 focus:border-brand-dark focus:ring-1 focus:ring-brand-dark/20 text-[15px] font-semibold text-slate-900 transition-all duration-300 outline-none"
                          />
                          <label className="absolute -top-2 left-4 bg-white px-2 text-[13px] font-semibold text-slate-650 tracking-wider">DISTRICT</label>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full px-5 py-4 rounded-2xl bg-white border border-slate-200 focus:border-brand-dark focus:ring-1 focus:ring-brand-dark/20 text-[15px] font-semibold text-slate-900 transition-all duration-300 outline-none"
                          />
                          <label className="absolute -top-2 left-4 bg-white px-2 text-[13px] font-semibold text-slate-650 tracking-wider">STATE *</label>
                        </div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full px-5 py-4 rounded-2xl bg-white border border-slate-200 focus:border-brand-dark focus:ring-1 focus:ring-brand-dark/20 text-[15px] font-semibold text-slate-900 transition-all duration-300 outline-none placeholder:text-mutedText"
                          />
                          <label className="absolute -top-2 left-4 bg-white px-2 text-[13px] font-semibold text-slate-650 tracking-wider">LANDMARK (OPTIONAL)</label>
                        </div>
                      </div>
                      ...
                      <button
                        type="submit"
                        className="w-full py-4.5 rounded-2xl bg-gradient-to-r from-brand-light to-brand-dark text-white font-bold text-[14px] tracking-normal transition-all duration-300 outline-none mt-2 flex items-center justify-center gap-1.5"
                      >
